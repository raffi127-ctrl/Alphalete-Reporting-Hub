...
# Held at 1 day for a few hours on 2026-09-13 while the "no view-resume link"
# verdict was suspect, and restored once it was proven false and fixed. The
# verdict this window governs is now only ever reached after the resume ACTUALLY
# OPENED and carried no number — a fact that does not change overnight, so
# re-reading it tomorrow is pure waste. A week is the compromise: long enough to
# stop the daily re-read of the whole settled backlog, short enough that a resume
# uploaded later is still picked up.
