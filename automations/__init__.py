...
Kept deliberately tiny and failure-proof: it installs one wrapper and nothing
else. Importing `automations` must never get slower or riskier because of this
file, and a broken hook must never stop a report from importing.
"""
try:
