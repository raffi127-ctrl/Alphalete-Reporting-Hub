...
# The SaraPlus account this report signs in as. Recorded because the alert
# that fires when SaraPlus demands a new password has to name it, and because
# it is NOT the same dealer as rc_contact_sync's B2B login.
