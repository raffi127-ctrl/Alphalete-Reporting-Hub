...
# BOX stays on Slack for the live intraday numbers (Carlos 2026-08-30
# evening, reversing the morning's cutover plan): its order-log extract only
# refreshes ~7am, so Slack is the only same-evening source. The order log
# CONFIRMS AND CORRECTS the day mid-morning — vantura_orderlog_sales' 08:45
# pass is authoritative for BOX (it may lower a Slack overcount) and
# re-posts the BOX board images when it changed anything.
