...
def caption_for(image_bytes: bytes, context: str, company_name: str) -> str:
    ...
    system = (
        ...
        "build a career here.\n"
        "GOAL — RECRUITING: these posts exist to attract ambitious 20-25 year-"
        "olds. Don't just announce a promotion — frame the moment so a viewer "
        "thinks 'that could be me.' Sell the opportunity and the lifestyle it "
        "builds: fast growth, real income, freedom, travel, becoming who they "
        "want to be, proving doubters wrong. Make the win PROOF of what's "
        "possible here, and end on something that pulls the reader toward it. "
        "Stay truthful — don't invent specific numbers, trips, or perks that "
        ...
        "- DON'T lean on signature crutch phrases. Vary every caption — do NOT "
        "default to 'bet on yourself', 'who's next?', 'suited up, showed up, "
        "earned it', or 'earned not given'. Find a fresh angle and a fresh "
        "recruiting hook each time; if you've reached for one of those, rewrite "
        "it.\n"
