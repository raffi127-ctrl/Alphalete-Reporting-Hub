...
| Carlos's, Eveliz's, **Luis's** | B2B 1-PAGER V3 (ATT TRACKER - B2B) — **dedicated per-team views** (no filter-setting): Carlos `.../D2D1-PAGERV3/32440800-0a5a-4f21-be33-f807ba5930a7/CarlosTeam`, Eveliz `.../D2D1-PAGERV3/48735d6e-cf6a-48fa-8d24-6f790d2ba3b7/EvelizsTeam`, Luis `.../D2D1-PAGERV3/e52b4954-dc0b-4f2a-a588-d218942f23a0/LuissCaptainship` | B2B (Sales By ICD – This Week, current week). Rollover adds the completed week's row to the hidden week-log underneath each Monday. ⚠ The `LuissCaptainship` URL was also recorded for the **B2B daily section** — confirm at build time which view the B2B daily section actually uses (it may have its own all-B2B view) vs Luis's captainship. |
