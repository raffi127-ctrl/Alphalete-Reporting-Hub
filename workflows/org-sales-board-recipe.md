...
|---|---|---|
| **Retail NL** | Tableau purpose-built view **"Retail NL Org Sales Board"** (Dropship V_2 / SARA PLUS SALES SUMMARY BY DAY): `.../DropshipV_2/SARAPLUSSALESSUMMARYBYDAY/6e2f1ff9-4f18-4e99-bef9-0644c8328082/RetailNLOrgSalesBoard` (GUID changes on re-save) | **Wireless Lines** per owner/day = **new lines only**. Set date=this week; view is pre-scoped to the Retail NL ICDs + Wireless Type=Phone. **TN Type must EXCLUDE "upgrade"** (upgrades don't count) — verify the purpose-built view already does, else un-click upgrade. Cross-check: day total matches. |
...
| Carlos's, Eveliz's, **Luis's** | B2B 1-PAGER V3 (ATT TRACKER - B2B) — **dedicated per-team views** (no filter-setting): Carlos `.../D2D1-PAGERV3/32440800-0a5a-4f21-be33-f807ba5930a7/CarlosTeam`, Eveliz `.../D2D1-PAGERV3/48735d6e-cf6a-48fa-8d24-6f790d2ba3b7/EvelizsTeam`, Luis `.../D2D1-PAGERV3/8f51c40d-46c3-4ddc-bf64-ec769777f3eb/LuissTeam` ⚠ **VERIFY** — Tableau may have defaulted to this view; confirm it's actually Luis's captainship (correct team filter) before relying on it | B2B (Sales By ICD – This Week, current week). Rollover adds the completed week's row to the hidden week-log underneath each Monday. (Note: the separate `LuissCaptainship` view = the **B2B daily section**, not Luis's captainship.) |
| Khalil's, Colten's, Jairo's | NDS-SN (RES-ATT-OOF) Workbook / Product Sales Summary (Rep) — **dedicated per-captain views**: Khalil `.../ProductSalesSummaryRep/7f7d9a86-425b-438a-8838-ffb1d16cde63/KHALILSTEAM`, Colten `.../ProductSalesSummaryRep/f6e61d86-e503-4c7d-9230-56b85048f402/COLTENSTEAM`, Jairo `.../ProductSalesSummaryRep/99c40989-62fd-4ffd-bc6e-c6e7fe78c0d7/JAIROSTEAM` | per-ICD **Total** per weekday, **ALL products** (NOT just Wireless like the NDS *daily* section), filters: captain's Team / all products / **This Week** (relative). Khalil ICDs: Khalil Mansour, Mohammed Altom, Juan Lucio, Isaiah Revelle, Ayleen Gonzalez, Zaid Arabiyat. |
